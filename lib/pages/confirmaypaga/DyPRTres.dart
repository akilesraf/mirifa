...
class PagoR3 extends StatefulWidget {
  @override
  _PagoR3State createState() => _PagoR3State();
}

class _PagoR3State extends State<PagoR3> {
  @override
  void initState() {
    super.initState();
    //items.addAll(numSel);
  ...
  void LKP3() {
    DatabaseReference DataRef = fire.database.ref('RifaTres').child('LinkP');
