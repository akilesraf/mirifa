...
class PagoR4 extends StatefulWidget {
  @override
  _PagoR4State createState() => _PagoR4State();
}

class _PagoR4State extends State<PagoR4> {
  @override
  void initState() {
    super.initState();
    //items.addAll(numSel);
  ...
  void LKP4() {
    DatabaseReference DataRef = fire.database.ref('RifaCuatro').child('LinkP');
