...
import 'package:mirifanet/services/unservices6.dart';
import 'package:share_plus/share_plus.dart';
import 'dart:html' as html;
import '../Home.dart';
import '../pages/confirmaypaga/CyPSeis.dart';
import '../pages/login_page.dart';
import '../services/userservices.dart';

class scrRifaSeis extends StatelessWidget {
  const scrRifaSeis();
  @override
...
class _Descripcion1 extends State<Descripcion1> {
  ...
  String Vendedor6 = 'Sin conexion';
  String FechaSorteo6 = 'Sin conexion';
  String MasInfo6 = 'Sin conexion';
  ...
  void RealtimeUpdate62() {
    DatabaseReference DataRef = fire.database.ref('RifaSeis').child('Vendedor');
  ...
  void RealtimeUpdate63() {
    DatabaseReference DataRef =
        fire.database.ref('RifaSeis').child('DesGeneral');
  ...
  void RealtimeUpdate64() {
    DatabaseReference DataRef =
        fire.database.ref('RifaSeis').child('FechaSorteo');
...
class _Numeros extends State<Numeros> {
  final databaseNum = fire.database.ref('RifaSeis');
  var numSel = "";
  var numPos = "";
  var numSelKey;
  var PP  = "Reciente";
  ...
  void initState() {
    super.initState();
    //items.addAll(numSel);
    _activateListeners661();
  }

  void _activateListeners661() {
    DatabaseReference DataRef =
        fire.database.ref('RifaSeis').child('Numeros').child("0");
                        ...
                        onPressed: () async {
                          ...
                          if (reg == true) {
                            if (_formulariokey.currentState.validate()) {
                              bool respuesta = await UsersServices6().saveNota(
                                _controlNombre.text,
...
class _Descripcion extends State<Descripcion> {
  ...
  String APText6 = 'Sin Conexion';
  String CMiniText6 = 'Sin Conexion';
  StreamSubscription _iniciopeticiones;
  @override
  void initState() {
    super.initState();
  ...
  void RealtimeUpdate66666() {
    DatabaseReference DataRef =
        fire.database.ref('RifaSeis/Descripcion').child('CMini');
